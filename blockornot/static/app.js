    ...
    function(state) {
        return {
            website: _.filter(
                ...
                _.bind(
                    function(website) {
                        return website.category_id === $(this).closest('.category').data('_category_id')
                    },
                    this
                )
            )
                    ...
                    function(website) {
                        $.get({
                            ...
                            success: function(data) {
                                dispatch(make_website_update(_.assign(
                                    {},
                                    website,
                                    {
                ...
                if($(this).data('website')) {
                    if($(this).data('website').anomaly) {
                        $(this)
                            .append(
                                $('<td>BLOCK</td>')
                                    .addClass('red lighten-5 red-text text-darken-4')
                            )
                    } else {
                        $(this)
                            .append(
                                $('<td>OK</td>')
                                    .addClass('green lighten-5 green-text text-darken-4')
                            )
                    }
                }
            }
